...
pdb.set_trace()
# rnn = LSTM(10, 20, 1, batch_first = True).cuda()    # (input_size, hidden_size, num_layers)
# inputs = Variable(torch.randn(3, 5, 10)).cuda()    # (batch_size, seq_len, input_size)
# h0 = Variable(torch.randn(1, 3, 20)).cuda()    # (1, batch_size, hidden_size)
# c0 = Variable(torch.rand(1, 3, 20)).cuda()
